...
public final class PhoneNumberFactory {
    ...
    public static PhoneNumber createPhoneNumberSafely(int areaCode, int centralOfficeCode, int phoneLineCode)  {
        ...
        String safePhoneNum = "(" + areaCode + ")" + "-"+  centralOfficeCode  + "-" + phoneLineCode;

        try{
            return createPhoneNumber(safePhoneNum);
        } catch (InvalidPhoneNumberFormatException invalidPhoneNumException) {
            logger.info(safePhoneNum + "is not a valid phone number");
            return null;
        }
    }
    ...
    public static PhoneNumber createPhoneNumber(String phoneNumberString) throws InvalidPhoneNumberFormatException {
        ...
        try{
           return new PhoneNumber(phoneNumberString);
            ...
            System.out.println("Invalid phone number pased: ");
